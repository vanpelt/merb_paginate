...
module MerbPaginate
  ...
  module Finders
    ...
    def self.activate!(which_one)
      "MerbPaginate::Finders::#{which_one.to_s.camelize}".constantize.activate!
    end
    ...
    module Datamapper
      ...
      def self.activate!
        DataMapper::Base.class_eval { include MerbPaginate::Finders::Datamapper } # load em up!
      end
